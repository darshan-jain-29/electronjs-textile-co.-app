...
const printingData = {
    ...
    tableUpperHeading: 'Finish-Purchase-G.R.',
...
function loadDataInViewFormat(billNumber) {
    ...
    connection.query(
        "SELECT * from finishgrmaster where invoiceNo = '" + billNumber + "';",
    ...
    connection.query(
        "SELECT * from finishgrrows where  invoiceNo = '" + billNumber + "';",
        function (error, results) {
            // console.log(results);
            if (error) { alert(error + " : Tab - "); throw error; }
