...
function generateHeader(doc, invoice) {
    ...
    doc
        .font('Helvetica-Bold')
        .fontSize(9)
        .text(invoice.miscType + ":", fromLeft + 400, fromTop + 3 + 12 * 2)
        .font('Helvetica')
        .fontSize(10)
        .text(invoice.miscValue, fromLeft + 400, fromTop + 3 + 12 * 3);
...
function generateTableHeadings(doc, invoice) {
    ...
    doc
        .fontSize(12)
        .text(invoice.tableUpperHeading, 40, 163, { align: 'center' });
...
function generateTableRowStyle2(
    ...
    doc
        ...
        .text(heading1, 80, y, { width: 140, align: "center" })
        .text(heading2, 220, y, { width: 100, align: "center" })
        .text(heading3, 320, y, { width: 50, align: "center" })
        .text(heading4, 370, y, { width: 50, align: "center" })
        .text(heading5, 420, y, { width: 50, align: "center" })
        .text(heading6, 470, y, { width: 80, align: "center" });
}
