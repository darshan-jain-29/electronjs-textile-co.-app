...
function loadData() {
  ...
  connection.query(
    "SELECT * from greypomaster where status = 'PENDING' ORDER BY uPoNumber DESC",
...
function viewDyeingReceivalDetails(id) {
  ...
  document.title = "View Grey Purchase - Received Details - " + temp[1] + " - Kalash Infotech";
  document.getElementById("pageHeading").innerHTML = "View Grey Purchase - Received Details - " + temp[1];
