...
function loadData() {
  ...
  connection.query(
    "SELECT * from grmaster where totalQty > 0 ORDER BY grSeries desc",
...
function viewAllGRList() {
  document.title = "All GR List - Kalash Infotech";
  document.getElementById("pageHeading").innerHTML = "All GR List";
  ...
  // document.getElementById("editPendingGRDetails").hidden = true;
